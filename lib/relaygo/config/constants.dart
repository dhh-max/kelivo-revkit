...
class Constants {
  ...
  static const String defaultUpdateFeedUrl =
      'https://raw.githubusercontent.com/relaygo-mobile/release/main/latest.json';
  ...
  // Hive 存储盒（添加relay_前缀避免与Kelivo原有存储冲突）
  static const String vaultBox = 'relay_vault'; // 主密钥等敏感信息
  static const String keysBox = 'relay_api_keys';
  static const String logsBox = 'relay_request_logs';
  static const String settingsBox = 'relay_settings';
  static const String rulesBox = 'relay_routing_rules';
  static const String alertsBox = 'relay_alerts';
  static const String providersBox = 'relay_providers'; // 用户自定义提供商
  ...
  static const String freeApiBox = 'relay_free_api_cache'; // 本地缓存盒
