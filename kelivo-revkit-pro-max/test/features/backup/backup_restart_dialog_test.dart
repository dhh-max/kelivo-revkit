...
import 'package:solab/features/backup/backup_restart_dialog.dart';
...
void main() {
  testWidgets('successful import uses restart dialog without merge counts', (
    ...
    expect(
      find.text('Import successful. Restart SoLab to apply it safely.'),
      findsOneWidget,
    );
    expect(find.textContaining('identical skipped'), findsNothing);
    expect(find.textContaining('conflicts remapped'), findsNothing);
    expect(find.textContaining('Restart SoLab'), findsOneWidget);
